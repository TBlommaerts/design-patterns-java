...
public class Main {
	...
	public static void main(String[] args) {
		...
		Movie movie1 = new Movie("Iron Man", Genre.ACTION, "Jon Favreau", LocalDate.of(2008, 5, 2), "Iron Man tells the story of Tony Stark, "
		...
		Movie movie4 = new Movie("The Shawshank Redemption", Genre.DRAMA, null, LocalDate.of(1994, 9, 23));
